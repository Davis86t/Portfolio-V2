...
export default function Intro() {
  return (
    <>
      <section
        id="home"
        className="z-0 mt-[-65px] flex min-h-screen flex-col justify-center border pb-[15px] sm:mt-0 sm:min-h-[calc(100vh-65px)] sm:pb-0"
        style={
          {
      ...
      >
        <div className=" flex h-full flex-col items-center border sm:mb-[100px] sm:pt-[8vh]">
